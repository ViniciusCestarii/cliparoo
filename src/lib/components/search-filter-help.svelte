    ...
    <div class="bg-base-100 p-6 rounded-md max-w-lg w-full">
      <div class="overflow-y-auto overflow-x-hidden max-h-[90vh]">
        ...
        <ul class="list-disc ml-5 mb-4">
          ...
          <li>
            <strong>window:</strong> Filters by the window name (e.g., <code>window:"Cliparoo App"</code>) - Enclose
            in quotes if it has spaces
          </li>
          <li><strong>text:</strong> Filters by the text content (e.g., <code>text:"Ola Brasil"</code>)</li>
        </ul>
        <p class="mb-4">
          If you want to search without specific filters, just enter the search term directly, and it will search
          across all fields (type, window, and text). Example: <code>john doe</code>.
        </p>
        <p>
